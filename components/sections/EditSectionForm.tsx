  ...
  return (
    <>
      ...
      <p className="text-sm font-medium mt-2">
        Complete this section with detailed information, a good video, and
        resources to provide the best learning experience for your students.
      </p>
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                <div className="space-y-0.5">
                  ...
                  <FormDescription>
                    Toggle to make this section available for free.
                  </FormDescription>
                </div>
                <FormControl>
                  <Switch
